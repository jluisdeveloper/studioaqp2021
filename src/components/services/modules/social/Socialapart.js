    ...
    <div className="apart_container">
      <div className="left_apart_service_wrapper">
        ...
        <div className="body_apart_service_wrapper">
          <span>04</span>
          <h3>Manejo de REDES SOCIALES en general</h3>
          <p>
          ...
          <Link to="/servicios/redes-sociales" className="btn_outline_service">
            Saber más
